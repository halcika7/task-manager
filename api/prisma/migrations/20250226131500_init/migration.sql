...
-- CreateEnum
CREATE TYPE "ActivityLogAction" AS ENUM ('CREATE_USER', 'UPDATE_USER', 'DELETE_USER', 'CREATE_TASK', 'UPDATE_TASK', 'DELETE_TASK', 'CREATE_COMMENT', 'UPDATE_COMMENT', 'DELETE_COMMENT', 'TASK_REMINDER');
